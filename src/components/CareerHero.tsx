			...
			<div className="max-w-7xl mx-auto px-4">
				<div className="grid md:grid-cols-2 gap-12 items-center">
					...
					<div className="space-y-6 text-black font-normal ">
						...
						{/* <motion.h2 className='lg:text-7xl text-5xl text-white'>Our story</motion.h2> */}
					...
					>
						<motion.p 
							...
							transition={{ duration: 0.5, delay: 0.2 }}
						>
							Who We Are Alpine Talent isn&apos;t just a staffing company—we&apos;re a strategic career accelerator committed to transforming professional potential into extraordinary success. We connect top talent with innovative opportunities across technology, recruitment, and business development.
						</motion.p>
						<motion.p 
